...
import {useNewSession, QUICK_NAMES} from "../hooks/useNewSession";
  ...
  return (
    <div>
      ...
      <div style={{marginBottom: 32}}>
        ...
        {loadingTemplates ? (
          <Preloader text="Loading Routines..." />
        ) : templates.length === 0 ? (
          <div
            className="card"
              ...
              >
                <div>
                  ...
                  <div style={{fontSize: 12, color: "var(--text-muted)"}}>
                    ...
                    {template.items.length === 1 ? "exercise" : "exercises"}
                  </div>
                </div>
                <button
                  className="btn-primary"

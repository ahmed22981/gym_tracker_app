...
export default function FoodLogModal({
  onClose, activeTab, setActiveTab, customMeals, servings, setServings,
  handleLogSavedMeal, handleDeleteCustomMeal, isSubmitting,
  quickAddForm, setQuickAddForm, handleQuickAdd,
  createMealForm, setCreateMealForm, handleCreateCustomMeal
}: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-[#111] border border-[#222] w-full max-w-3xl rounded-4xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex justify-between items-center py-8 border-b border-[#222]" style={{ paddingLeft: '48px', paddingRight: '48px' }}>
          ...
          <button onClick={onClose} className="text-[#666] hover:text-white transition-colors cursor-pointer" style={{ marginRight: '16px' }}>
            <X size={32} />
          </button>
        </div>

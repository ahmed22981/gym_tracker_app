  ...
  const steps = [
    {
      ...
      description:
        "Start by adding your favorite exercises. Include names, target muscles, and YouTube videos for form reference.",
    },
    {
      icon: <ListPlus size={42} color="var(--accent)" />,
      title: "CREATE ROUTINES",
      description:
        "Head over to 'New Session' to build your workout routines. Group your exercises so they're ready to go.",
    },
    {
      icon: <TrendingUp size={42} color="var(--accent)" />,
      title: "TRACK & PROGRESS",
      description:
        "Log your sets. We'll automatically pre-fill your previous weights and reps to help you focus on progressive overload.",
    },
    {
      icon: <Flame size={42} color="var(--accent)" />,
      title: "ANALYZE PERFORMANCE",
      description:
        "Check the Analytics page to see your workout heatmap and track your personal max weights over time.",
    },
  ];
          ...
          >
            ...
            <div style={{minHeight: 110}}>
              <h2
                ...
                style={{fontSize: 24, marginBottom: 12, lineHeight: 1.1}}
              >
